...
public class Account {
    ...
    public Account(int permission_id) {
    ...
    public Account(int id, int customer_id, int employee_id) {
        this.id = id;
    ...
    public Account(String username, int id, int customer_id) {
        this.username = username;
        this.id = id;
        this.customer_id = customer_id;
    }

    public Account(String username, int id, int employee_id, int permission_id) {
        this.username = username;
        this.id = id;
        this.employee_id = employee_id;
        this.permission_id = permission_id;
    ...
    public Account(String username, String password, int id, int employee_id, int customer_id, int permission_id) {
        this.username = username;
        this.password = password;
        this.id = id;
        this.employee_id = employee_id;
