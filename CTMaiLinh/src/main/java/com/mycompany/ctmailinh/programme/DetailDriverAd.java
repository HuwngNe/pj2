 ...
 * @author Windows
 */
public class DetailDriverAd extends javax.swing.JFrame {
    IdDataAdmin iddataad = new IdDataAdmin();
    /**
     * Creates new form DetailDriverAd
     */
    public DetailDriverAd() {
        initComponents();
        setLocationRelativeTo(null);
        Employee emp = QuerryEmployee.findById(iddataad.getIdDriver());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailDriverAd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailDriverAd().setVisible(true);
            }
        });
    }
