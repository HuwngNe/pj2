 ...
 * @author Windows
 */
public class DetailDriverEmp extends javax.swing.JFrame {
    IdDataEmp iddata = new IdDataEmp();
    /**
     * Creates new form DetailDriverEmp
     */
    public DetailDriverEmp() {
        initComponents();
        setLocationRelativeTo(null);
        Employee emp = QuerryEmployee.findById(iddata.getDriverEmp_id());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailDriverEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailDriverEmp().setVisible(true);
            }
        });
    }
