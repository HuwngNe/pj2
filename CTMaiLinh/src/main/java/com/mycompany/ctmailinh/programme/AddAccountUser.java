 ...
 * @author Windows
 */
public class AddAccountUser extends javax.swing.JFrame {

    /**
     * Creates new form AddAccountUser
     */
    public AddAccountUser() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (pass.length() < 8) {
            JOptionPane.showMessageDialog(rootPane, "Mật khẩu không được nhỏ hơn 8 ký tự","Lỗi",JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (!pass.equals(confirm)) {
            JOptionPane.showMessageDialog(rootPane, "Mật khẩu nhập lại phải giống mật khẩu");
            return;
        }
        Customer cus = new Customer();
        cus.setFullname(name);
        int idCus = QuerryCustomer.insertGetID(cus);
        Account acc = new Account();
        acc.setCustomer_id(idCus);
        acc.setUsername(txtaccount.getText());
        acc.setPassword(pass);
        acc.setPermission_id(1);
        QuerryAccount.insert(acc);
        JOptionPane.showMessageDialog(rootPane, "Thêm thành công tài khoản mới","Thông báo",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAccountUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddAccountUser().setVisible(true);
            }
        });
    }
