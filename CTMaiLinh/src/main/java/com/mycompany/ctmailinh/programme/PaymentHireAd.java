 ...
 * @author Windows
 */
public class PaymentHireAd extends javax.swing.JFrame {
    IdLogin idlogin = new IdLogin();
    IdDataAdmin iddataad = new IdDataAdmin();
    private int price = 0;
    private String tong = "";
    /**
     * Creates new form PaymentHireAd
     */
    public PaymentHireAd() {
        initComponents();
        setLocationRelativeTo(null);
        price = Integer.parseInt(QuerryVehice.findReturnPrice(iddataad.getIdVehice()));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            QuerryHire.updatePay(iddataad.getIdChooseHire(), idlogin.getId(),txttotal.getText());
            QuerryVehice.updateStatus(iddataad.getIdVehice(), 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentHireAd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentHireAd().setVisible(true);
            }
        });
    }
