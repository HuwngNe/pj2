 ...
 * @author Windows
 */
public class DetailCustomerAd extends javax.swing.JFrame {
    IdDataAdmin iddataad = new IdDataAdmin();
    /**
     * Creates new form DetailCustomerAd
     */
    public DetailCustomerAd() {
        initComponents();
        setLocationRelativeTo(null);
        Customer emp = QuerryCustomer.find(iddataad.getIdCustomer());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DetailHireAd detailhire = new DetailHireAd();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailCustomerAd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailCustomerAd().setVisible(true);
            }
        });
    }
