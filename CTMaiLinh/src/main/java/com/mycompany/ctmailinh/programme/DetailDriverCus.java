 ...
 * @author Windows
 */
public class DetailDriverCus extends javax.swing.JFrame {
    IdDriverCus iddriver = new IdDriverCus();
    /**
     * Creates new form DetailDriverCus
     */
    public DetailDriverCus() {
        initComponents();
        setLocationRelativeTo(null);
        Employee emp = QuerryEmployee.findById(iddriver.getDriver_id());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thông tin lái xe");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailDriverCus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailDriverCus().setVisible(true);
            }
        });
    }
